                    ...
                    <div className="bg-[#FFD8B1] py-8">
                        <div className="container px-4 mx-auto text-center">
                            <img
                                ...
                                style={{ width: '100px', height: '100px' }} // Añadir estilos en línea para restringir el tamaño
                            />
                            <p className="text-gray-700">
                                Presentando a los miembros del equipo
                            </p>
                                    ...
                                    >
                                        ...
                                        <div className="text-center text-gray-300">
                                            {player.golesTotales > 0 && (
                                                <p>
                                                    Goles: {player.golesTotales}
                                                </p>
                                            )}
                                            {player.tarjetasAmarillasTotales >
                                                0 && (
                                                <p>
                                                    Tarjetas Amarillas:{" "}
                                                    {
